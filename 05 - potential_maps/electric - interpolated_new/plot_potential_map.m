...
% plot_potential_map(InterpSignal.Data.MEA1, 5000);
% % Multiple samples with custom title
% plot_potential_map(InterpSignal.Sync.MEA2, 1000:5:1200, 'title', 'MEA2 - Ventricle - Stimulation');
% % With specific limits and tank data
% plot_potential_map(InterpSignal.Data.TANK, 2000, 'lim', [-200 200], 'title', 'Tank - High Amplitude');
% % Custom colormap and no colorbar
% plot_potential_map(InterpSignal.Data.MEA3, 3000:100:3200, ...
%     'colormap', 'hot', 'colorbar', false, 'title', 'MEA3 - Custom Colors');
% % Show grid coordinates
% plot_potential_map(InterpSignal.Sync.MEA1, 1500, 'grid', true, 'title', 'MEA1 with Grid');
% % Auto limits (empty lim)
% plot_potential_map(InterpSignal.Data.TANK, 2500, 'lim', [], 'title', 'Tank - Auto Scaling');