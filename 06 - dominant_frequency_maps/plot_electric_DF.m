...
switch caso
    case 1
        ...
        % Plot MEA1
        plotMEA(DF_MEA1, MEA, MEA_plane_indx, 'MEA 1 (Right Atrium)', lim);
    ...
    case 2
        ...
        % Plot MEA1
        plotMEA(DF_MEA2, MEA, MEA_plane_indx, 'MEA 2 (Ventricle)', lim);
    ...
    case 3
        ...
        % Plot MEA3
        plotMEA(DF_MEA3, MEA, MEA_plane_indx, 'MEA 3 (Left Atrium)', lim);
    ...
    case 4
        ...
        % Plot the tank
        plotTank(DF_TANK, Plane, tank_plane_indx, 'TANK' ,lim);
