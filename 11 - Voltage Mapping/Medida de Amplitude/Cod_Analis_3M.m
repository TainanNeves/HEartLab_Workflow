...
T = {'MEA1-RA', 'MEA2-V', 'MEA3-LA'}; 

MEAs = {1:16, 17:32, 65:80};     
...
MEA3 = {65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79};

MEA_all = {MEA1, MEA2, MEA3}; 

%% PARTE 6 - DETERMINAÇÃO DOS EVENTOS DE ATIVAÇÃO

eletrodos_analise = [8, 69, 22]; janela_tempo = [2 6];
...
savefig(fullfile(output_folder, [folderName '_F2_RA_LA_V_Marcados_.fig'])); 
disp('Finalizado!');
