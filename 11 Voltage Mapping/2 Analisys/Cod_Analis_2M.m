...
T = {'MEA1-RA', 'MEA2-LA'}; MEAs = {1:16, 17:32}; 
...
eletrodos_analise = [18, 7]; janela_tempo = [2 6];
...
for i = 1:2
    subplot(2,1,i); e = eletrodos_analise(i);
    if e <= 16
        mea_idx = 1;
    else
        mea_idx = 2;
...
savefig(fullfile(output_folder, [folderName '_F2_RA_LA_Marcados_.fig'])); disp('Finalizado!');
...
MEA_all = {MEA1, MEA2}; MEA_names = {'MEA1-RA', 'MEA2-LA'};
...
save(fullfile(output_folder, [folderName '_heart_rate_results.mat']), 'HR_str', 'janela', '-v7.3');

%% PARTE 11 - ESTATÍSTICA DAS FREQUÊNCIAS DE ATIVAÇÃO E CYCLE LENGTHS

MEA_names = {'MEA1-RA', 'MEA2-LA'}; valid_AF = struct();
...
mea_names = {'MEA1-RA', 'MEA2-LA'}; colors = [0 0.4470 0.7410; 0.8500 0.3250 0.0980]; bar_width = 0.35;
...
MEAs = {[MEA1{:}], [MEA2{:}]}; MEA_nomes = {'MEA1-RA', 'MEA2-LA'};
