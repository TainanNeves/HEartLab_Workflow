...
T = {'MEA 1 - RA', 'MEA 2 - V', 'MEA 3 - LA'}; MEAs = {1:16, 17:32, 65:80};
...
f0 = [60, 120]; Q = 30; DATA.CONTINUOS.SF = DATA.CONTINUOS.Data;
...
LEI = [14, 25, 78]; R = {'MEA1', 'MEA2', 'MEA3'};

figure;
for i = 1:length(LEI)
    subplot(3, 1, i); SS = DATA.CONTINUOS.SF(LEI(i), :);
