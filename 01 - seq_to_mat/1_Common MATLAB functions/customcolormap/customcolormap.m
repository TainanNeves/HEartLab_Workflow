...
% ----------------------------------------------------------------------- %
% Ilija add   
% C = customcolormap([0 (M-L)/(U-L) 1], [0.5,0.4 0; 1 1 1;  0.4 0  0.5; ] ,32);
% this one is used for APD maps
% C = customcolormap([0 (0.5-0)/(1-0) 1], [0.8,0.4 0; 1 1 1;  0.5 0  0.9; ] ,64);%[1 0 0; 1 1 1; 0 0 1],32);
% this one used for movie
