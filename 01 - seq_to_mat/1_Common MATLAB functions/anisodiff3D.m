...
%         aux = conv(diff3pp,h1,'same'); nabla1 = aux(:,:,2);
%         aux = conv(diff3pp,h2,'same'); nabla2 = aux(:,:,2);
%         aux = conv(diff3pp,h3,'same'); nabla3 = aux(:,:,2);
%         aux = conv(diff3pp,h4,'same'); nabla4 = aux(:,:,2);
%         aux = conv(diff3pp,h5,'same'); nabla5 = aux(:,:,2);
%         aux = conv(diff3pp,h6,'same'); nabla6 = aux(:,:,2);
%         aux = conv(diff3pp,h7,'same'); nabla7 = aux(:,:,2);
%         aux = conv(diff3pp,h8,'same'); nabla8 = aux(:,:,2);
%         aux = conv(diff3pp,h9,'same'); nabla9 = aux(:,:,2);
%         aux = conv(diff3pp,h10,'same'); nabla10 = aux(:,:,2);
%         aux = conv(diff3pp,h11,'same'); nabla11 = aux(:,:,2);
%         aux = conv(diff3pp,h12,'same'); nabla12 = aux(:,:,2);
%         aux = conv(diff3pp,h13,'same'); nabla13 = aux(:,:,2);
%         aux = conv(diff3pp,h14,'same'); nabla14 = aux(:,:,2);
%         aux = conv(diff3pp,h15,'same'); nabla15 = aux(:,:,2);
%         aux = conv(diff3pp,h16,'same'); nabla16 = aux(:,:,2);
%         aux = conv(diff3pp,h17,'same'); nabla17 = aux(:,:,2);
%         aux = conv(diff3pp,h18,'same'); nabla18 = aux(:,:,2);
%         aux = conv(diff3pp,h19,'same'); nabla19 = aux(:,:,2);
%         aux = conv(diff3pp,h20,'same'); nabla20 = aux(:,:,2);
%         aux = conv(diff3pp,h21,'same'); nabla21 = aux(:,:,2);
%         aux = conv(diff3pp,h22,'same'); nabla22 = aux(:,:,2);
%         aux = conv(diff3pp,h23,'same'); nabla23 = aux(:,:,2);
%         aux = conv(diff3pp,h24,'same'); nabla24 = aux(:,:,2);
%         aux = conv(diff3pp,h25,'same'); nabla25 = aux(:,:,2);
%         aux = conv(diff3pp,h26,'same'); nabla26 = aux(:,:,2);
